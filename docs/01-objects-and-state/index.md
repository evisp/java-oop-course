...
-   :material-laptop:{ .lg .middle } **Your first classes**
    ...
    Three classes of your own, from the design you made in week 1.
...
-   :material-laptop:{ .lg .middle } **Making them refuse**
    ...
    Go back to your own classes and make them impossible to break.
...
Every lecture in this module builds the same thing: a small bank. It is a good problem to learn on because everyone already knows the rules, and because those rules are strict. A balance cannot go negative. An account number never changes. Money that leaves one place has to arrive somewhere.
