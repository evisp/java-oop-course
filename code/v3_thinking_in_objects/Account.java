...
import v3_thinking_in_objects.Transaction.TransactionType;

/**
 * Represents a bank account with transaction history and enhanced functionality.
 * This version demonstrates transaction tracking, equals/hashCode, and immutability.
 * 
 * @author Evis Plaku
 * @version 3.0
 */
public class Account {
    ...
    public Account(double initialBalance) {
        ...
        if (initialBalance > 0) {
            Transaction initialDeposit = new Transaction(TransactionType.DEPOSIT,
            		initialBalance, accountId, balance, "Initial Deposit");
